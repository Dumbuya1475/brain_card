		...
		switch (mode) {
			...
			case 'embeddedImages':
				...
				array = [
					...
					{ name: '2', img: './assets/card_images/img1.png' }, { name: '2', img: './assets/card_images/img1.png' },
					{ name: '3', img: './assets/card_images/img3.png' }, { name: '3', img: './assets/card_images/img3.png' },
					{ name: '4', img: './assets/card_images/img4.png' }, { name: '4', img: './assets/card_images/img4.png' },
					{ name: '5', img: './assets/card_images/img5.png' }, { name: '5', img: './assets/card_images/img5.png' },
					{ name: '6', img: './assets/card_images/img6.png' }, { name: '6', img: './assets/card_images/img6.png' },
					{ name: '7', img: './assets/card_images/img7.png' }, { name: '7', img: './assets/card_images/img7.png' },
					{ name: '8', img: './assets/card_images/img8.png' }, { name: '8', img: './assets/card_images/img8.png' }
				];
				break;
			case 'emoji':
